...
class _GaugeState extends State<Gauge> {
  ...
  Widget build(BuildContext context) {
          ...
          GaugeRange(
            ...
            annotations: <GaugeAnnotation>[
              GaugeAnnotation(
                ...
                axisValue: 5,
                positionFactor: 0.1,
                widget: Text('${widget.annotation}', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
              ),
              GaugeAnnotation(
                  angle: 90,
                  axisValue: 5,
    ...
    widget: Text('${widget.value}',style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold) )
              ),
